...
const req = https.request(options, res => {
  ...
  res.on('end', () => {
    ...
    if (node) {
      let matchParameters = node.parameters.matchParameters.parameters;
      let phoneParam = matchParameters.find(p => p.name === 'telefone_principal');
      
      phoneParam.value = "={{ $json.instance.startsWith('55') ? $json.instance : '55' + $json.instance }}";
      console.log("Updated node parameter to:", phoneParam.value);
    }
